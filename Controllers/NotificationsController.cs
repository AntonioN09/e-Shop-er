...
namespace EShop.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,IsActive,CreatedDate")] Notification notification)
        {
        ...
        public async Task<IActionResult> DisplayActiveNotifications(int UserId)
        {
            var notifications = _context.Notifications.Include(n => n.User);
            var activeNotifications = notifications.Where(n => n.IsActive == true);

            return View(await activeNotifications.ToListAsync());
        }
    }
}
